...
Revision ID: a0f37e6cf80b
Revises:
Create Date: 2026-06-29 13:48:07.812008

"""

from typing import Sequence, Union

import rungoal.models  # For custom TypeAnnotations
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "data_source",
            sa.Enum("GOOGLE_HEALTH", "RUNTRACKER", name="rundatasource"),
            nullable=False,
        ),
